...
public class RoleDaoImpl extends BaseDaoImpl<Role> implements RoleDao {
    ...
    @Override
    public PreparedStatement setCustomConditions(Connection conn, Role entity, StringBuffer sql, Sortable sortArgs, Pagination pageArgs) throws SQLException {
        // 追加条件
        ...
        if(DataUtil.isNotEmpty(entity)) {
            ...
            if(DataUtil.isNotEmpty(entity.getMenuKey())) {
                whereStr.append("and menu_key like ? ");
            }
        ...
        if(DataUtil.isNotEmpty(entity)) {
            ...
            if(DataUtil.isNotEmpty(entity.getMenuKey())) {
                JdbcUtil.setString(ps, count++, "%" + entity.getMenuKey() + "%");
            }
            if(DataUtil.isNotEmpty(entity.getKeyword())) {
